...
<body>
    ...
    <div class="navbar">
        ...
        <div class="hello">
            <img src="image/ok.png" alt="" class="ok"><br><br>
            <p> You have completed your registration successfully!<br><br> <b> Wellcome to All in one 4 HER PLatform.</b>  </p><br>
        
            
            <p><a href="index.html">Go to Homepage to sign in</a></p>
