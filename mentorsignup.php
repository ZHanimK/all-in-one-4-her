<?php
  ...
  $_SESSION['firstname'] = $_POST['firstname'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert = $db -> prepare("INSERT INTO mentor (`firstname`, `lastname`, `age`, `education`, `sector`, `experience`, `email`, `all_password`, `who`) " . "VALUES(:firstname,:lastname,:age,:education,:sector,:experience,:email,:all_password,3)");
...
<head>
    ...
    <title>Sign-up as a Mentor</title>
    <!-- Favicon -->
