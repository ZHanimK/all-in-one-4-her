<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert = $db -> prepare("INSERT INTO her (`firstname`, `lastname`, `age`, `education`, `sector`, `experience`, `email`, `all_password`, `who`) " . "VALUES(:firstname,:lastname,:age,:education,:sector,:experience,:email,:all_password,3)");
...
<body>
    ...
    <div class="container">
        ...
        <h2>Sign Up Form for Mentors</h2>
        ...
        <div class="formContainer">
            <form action="mentorsignup.php" method="POST">
                ...
                <div class="box2">
                    ...
                    <div class="label">
                        <label for="experience">Working Experience (years)</label></div>
