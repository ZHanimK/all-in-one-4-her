<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert = $db -> prepare("INSERT INTO her (`firstname`, `lastname`, `position`, `organisation`, `region`, `email`, `all_password`, `who`) " . "VALUES(:firstname,:lastname,:position,:organisation,:region,:email,:all_password,4)");
        ...
        if ($_POST['all_password'] === $_POST['confirmpassword']) {
            ...
            $insert->bindValue(':organisation', $_POST['organisation']);
            $insert->bindValue(':region', $_POST['region']);
            $insert->bindValue(':email', $_POST['email']);
            $insert->bindValue(':all_password', $_POST['all_password']);
     
            if ($insert->execute()) {$email = $_POST['email'];
...
<body>
    ...
    <div class="container">
        ...
        <h2>Sign Up Form for Government Organisations</h2>

        <div class="formContainer">
            <form action="governmentsignup.php" method="POST">
                <div class="box1">
                    <div class="label">
                    ...
                    <div class="label">
                        <label for="organisation">Organisation Name</label></div>
                    <input type="text" id="organisation" name="organisation" required>
                    <div class="label">
                        <label for="region">Region / City</label></div>
                ...
                <div class="box2">
                    ...
                    <input type="text" id="all_password" name="all_password" required>
