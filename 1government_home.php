...
<body>
    ...
    <div class="navbar">
        ...
        <div class="hello">
            ...
            <p> Wellcome to All in one 4 HER Platform!<br>
            You are registered as a Government Institution. <br>
            <br> This page is still under construction. You will be informed as soon as it is activated.</p><br>
        </div>
