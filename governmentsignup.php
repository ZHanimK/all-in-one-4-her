<?php
  ...
  $_SESSION['firstname'] = $_POST['firstname'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert = $db -> prepare("INSERT INTO organisation (`firstname`, `lastname`, `position`, `organisation`, `region`, `email`, `all_password`, `who`) " . "VALUES(:firstname,:lastname,:position,:organisation,:region,:email,:all_password,4)");
...
<head>
    ...
    <style type="text/css">
        ...
        .md-form.md-outline input[type=number]:focus:not([readonly]) {
            border-color: #7CF5AB;
            box-shadow: inset 0 0 0 1px #7CF5AB;
        }
        ...
        border-color: #7CF5AB;
        outline: 0;
        box-shadow: 0 0 0 0.01rem rgb(124, 245, 171);
        }
